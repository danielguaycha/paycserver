...
<head>
    ...
    <link rel="icon" type="png" href="{{ asset('img/payicon.png') }}">
    <!-- CSRF Token -->
    <meta name="csrf-token" content="{{ csrf_token() }}">

    <title>Cargando layout</title>
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    <img src="{{ asset('img/payicon.png')  }}" width="30" height="30" alt="">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            @role('Admin')
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="{{ route('employ.index') }}">Ver todos</a>
                                        <a class="dropdown-item" href="{{ route('employ.create') }}">Agregar Empleado</a>
                                        <a class="dropdown-item" href="#">Pago de sueldo</a>
                                        <a class="dropdown-item" href="#">Adelanto de sueldo</a>
                                    </div>
                                </li>
                            @endrole
                        @endauth
