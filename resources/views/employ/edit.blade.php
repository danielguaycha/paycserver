    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('employ.update', ['employ' => $employ->id ]) }}" method="post">
                        {{ csrf_field() }}
                        @method('PUT')
                        <div class="form-group form-row">
                            ...
                            <div class="col">
                                ...
                                <input type="text"
                                       id="name"
                                       value="{{ old('name', strtoupper($employ->name) ) }}"
                                       max="100"
                                       required
                            ...
                            <div class="col">
                                ...
                                <input type="text"
                                       id="surname"
                                       max="100"
                                       value="{{ old('surname', strtoupper($employ->surname) ) }}"
                                       required
                        ...
                        <div class="form-group form-row">
                            ...
                            <div class="col-md-5">
                                ...
                                <input type="text"
                                       id="phones"
                                       value="{{ old('phones', $employ->phones ) }}"
                                       required
                            ...
                            <div class="col-md-7">
                                ...
                                <input type="text"
                                       id="address"
                                       value="{{ old('address', $employ->address ) }}"
                                       max="100"
                                       required
                        ...
                        <div class="form-group form-row">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="number"
                                       id="sueldo"
                                       value="{{ old('sueldo', $employ->sueldo ) }}"
                                       required
                        ...
                        <div class="form-group form-row">
                            ...
                            <div class="col">
                                ...
                                <input type="text"
                                       id="username"
                                       max="100"
                                       value="{{ old('username', $employ->username ) }}"
                                       required
